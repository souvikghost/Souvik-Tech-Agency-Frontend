...
// Pass role="admin" | "employee" | "client" from the route
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="bg-white border border-primary/8 rounded-2xl p-6 flex items-center gap-6">
          <div className="relative shrink-0">
            ...
            {/* Avatar upload — allowed for ALL roles */}
          ...
          <div>
            ...
            <p className="text-primary/60 text-xs mt-2">JPG, PNG — max 1MB</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input value={form.email} disabled
                className="w-full px-3 py-2.5 rounded-xl border border-primary/8 bg-primary/4 text-primary/60 text-sm cursor-not-allowed" />
              <p className="text-primary/60 text-[10px] mt-1">Email cannot be changed</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white border border-primary/8 rounded-2xl p-6 flex items-center justify-between">
          <div>
            <p className="text-primary/60 text-xs font-semibold uppercase tracking-widest">Role</p>
            <p className="text-primary font-semibold text-sm mt-1 capitalize">{role}</p>
          </div>
          <span className="px-3 py-1 bg-primary/8 text-primary text-xs font-semibold rounded-full capitalize">{role}</span>
        </div>

        {/* Save — only admin and avatar change for others */}
        <div className="flex justify-end">
          <button type="submit"
            className="px-6 py-2.5 bg-primary text-secondary text-sm font-semibold rounded-lg transition hover:bg-primary/90">
            Save Changes
          </button>
        </div>
      </form>
